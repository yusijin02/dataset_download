...
wget -c -i $url -P $curr_dl --no-check-certificate
...
[ ! -d $curr_dl ] && mkdir -p $curr_dl
wget -c $url -P $curr_dl --no-check-certificate
...
[ ! -d $curr_dl ] && mkdir -p $curr_dl
wget -c $url_tr -P $curr_dl --no-check-certificate
wget -c $url_v -P $curr_dl --no-check-certificate
wget -c $url_t -P $curr_dl --no-check-certificate

# Download readme
url=http://s3.amazonaws.com/kinetics/400/readme.md
wget -c $url -P $root_dl --no-check-certificate
